  ...
  return (
    <div className="flx container">
      <Blob title="Services" idNum="service">
        Thanks to our <span className="highlight">unique production pipeline</span> and <span className="highlight">broad range of world-class talent</span>, we can provide <span className="highlight">all of these services</span> for your project:
      </Blob>
